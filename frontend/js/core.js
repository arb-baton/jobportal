...
export function makeFallbackImage(name = "", symbol = "") {
  const label = sanitizeTokenSymbol(name || symbol || "JOB");
  const svg = `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 400'>
    <defs>
      <linearGradient id='pumpGlow' x1='0' y1='0' x2='1' y2='1'>
        <stop offset='0%' stop-color='#85f7ae'/>
        <stop offset='100%' stop-color='#20d66b'/>
      </linearGradient>
      <radialGradient id='pumpWash' cx='30%' cy='22%' r='80%'>
        <stop offset='0%' stop-color='rgba(133,247,174,.34)'/>
        <stop offset='100%' stop-color='rgba(133,247,174,0)'/>
      </radialGradient>
    </defs>
    <rect width='400' height='400' rx='26' fill='#0b0f0d'/>
    <rect x='1' y='1' width='398' height='398' rx='26' fill='url(#pumpWash)'/>
    <path d='M40 312 C105 270 143 286 202 308 S315 346 360 296' fill='none' stroke='#7df2aa' stroke-width='6' stroke-linecap='round' opacity='.95'/>
    <path d='M38 326 C116 302 152 318 205 329 S307 351 361 322' fill='none' stroke='#1ed760' stroke-width='2.4' stroke-linecap='round' opacity='.56'/>
    <circle cx='318' cy='88' r='88' fill='url(#pumpGlow)' opacity='.18'/>
    <circle cx='82' cy='338' r='118' fill='url(#pumpGlow)' opacity='.12'/>
    <rect x='22' y='22' width='356' height='356' rx='28' fill='none' stroke='rgba(125,242,170,.34)' stroke-width='2'/>
    <text x='200' y='218' text-anchor='middle' fill='#f7fff9' font-family='Arial, Helvetica, sans-serif' font-size='86' font-weight='900' letter-spacing='0'>${label}</text>
  </svg>`;
