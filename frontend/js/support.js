...
const HELP_COLLECTIONS = [
  {
    ...
    description: "Job application setup, Pump.fun launch flow, and post-launch management.",
    author: "Get Me a Job Team",
    articles: [
      {
        key: "create-coin",
        ...
        blocks: [
          { type: "p", text: "Job Application launches your Get Me a Job profile token through Pump.fun with your job title, resume, and job app pic." },
          {
            type: "faq",
            items: [
              ...
              { q: "What is the Job Token?", a: "The Job Token is fixed to GETMEAJOB for every application." },
    ...
    return `
      <div class="support-home-hero">
        <div class="support-home-top">
          <div class="support-home-logo"><img src="/assets/pump-r-logo.png" alt="Get Me a Job logo" /></div>
  ...
  function renderCompose(category = "general") {
    ...
    body.innerHTML = `
      <div class="support-pane support-compose-pane">
        ...
        <div class="support-note-box">This chat is for Get Me a Job support. Please keep messages focused on support issues.</div>
